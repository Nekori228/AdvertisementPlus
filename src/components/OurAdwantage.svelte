...
<main>
    ...
    <div class="grid">
        <div class="block">
            ...
            <p>
                Возьмём работу любой сложности и выполним наилучшим образом.
        ...
        <div class="block">
            ...
            <p>
                Всегда крепим надежно любые конструкции, учитывая северный
        ...
        <div class="block">
            ...
            <p>
                Мы используем самые яркие светодиоды, и не экономим на них.
                Яркость - наш успех.
            </p>
        </div>
        <div class="block">
            ...
            <p>
                Так отзываются наши заказчики) Свои отзывы можете оставлять на
